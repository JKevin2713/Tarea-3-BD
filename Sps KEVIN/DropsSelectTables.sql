...
DROP TABLE dbo.TotalMinutosLlamada
DROP TABLE dbo.TotalGigasUso


DROP TABLE dbo.LlamadasX 
DROP TABLE dbo.LlamadasY 
DROP TABLE dbo.ResumenLlamadasX 
DROP TABLE dbo.ResumenLlamadasY 
...
SELECT * FROM dbo.TotalMinutosLlamada --WHERE MinutosBase > 0
SELECT * FROM dbo.TotalGigasUso
