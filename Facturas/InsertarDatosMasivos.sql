...
/****** Object:  StoredProcedure [dbo].[XMLInsertarDatosMasivos]    Script Date: 31/05/2024 19:28:01 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    BEGIN TRY
        ...
        ---------------------------------------------------------------------------
			...
			EXEC [dbo].[agregarFactura] @InFechaOperacion = @actual, @InCrearFactura = 0;
		...
		---------------------------------------------------------------------------
			...
			BEGIN
				...
				EXEC [dbo].[agregarFactura] @InFechaOperacion = @actual, @InCrearFactura = 1;
			END;
