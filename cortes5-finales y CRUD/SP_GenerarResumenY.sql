...
--------------------------------------------------------------------
ALTER PROCEDURE [dbo].[GenerarResumenLlamadasY]
...
EXEC [dbo].[GenerarResumenLlamadasY] @outResultCode OUTPUT;


SELECT * FROM ResumenLlamadasY
SELECT * FROM LlamadasY
SELECT * FROM LlamadasX

DROP TABLE ResumenLlamadasY
